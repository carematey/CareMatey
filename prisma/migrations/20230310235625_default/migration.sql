...
-- CreateTable
CREATE TABLE "SpaceAuthorization" (
    "id" SERIAL NOT NULL,
    "spaceId" INTEGER NOT NULL,
    "spaceName" TEXT,
    ...
    CONSTRAINT "SpaceAuthorization_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "SpaceAuthorization" ADD CONSTRAINT "SpaceAuthorization_authorizedUserId_fkey" FOREIGN KEY ("authorizedUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SpaceAuthorization" ADD CONSTRAINT "SpaceAuthorization_spaceId_fkey" FOREIGN KEY ("spaceId") REFERENCES "Space"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
